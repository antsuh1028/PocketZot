    ...
    return (
      <Box bg="#72645E" p={4} h="full">
        <VStack align="stretch" gap={4} px={8} maxW="350px" mx="auto" justify="center" alignItems="center">
          ...
          <Box py={4} px={10} border="solid black 2px" bg="white" borderRadius={10} justifyContent="center" alignItems="center">
            <VStack>
                <Image src="IdleState.png" width="150px"/>
                <Text fontFamily="'Press Start 2P'" fontSize="3xl">Georgia</Text>
